...
#let terminal-themes = (
  ...
  rose-pine: (
    ...
    white: rgb("#e0def4"),
    gray: rgb("#6e6a86"),
    bright-red: rgb("#eb6f92"),
    bright-green: rgb("#31748f"),
    bright-yellow: rgb("#f6c177"),
    bright-blue: rgb("#9ccfd8"),
    bright-magenta: rgb("#c4a7e7"),
  ...
  rose-pine-dawn: (
    ...
    white: rgb("#575279"),
    gray: rgb("#6e6a86"),
    bright-red: rgb("#b4637a"),
    bright-green: rgb("#286983"),
    bright-yellow: rgb("#ea9d34"),
    bright-blue: rgb("#56949f"),
    bright-magenta: rgb("#907aa9"),
